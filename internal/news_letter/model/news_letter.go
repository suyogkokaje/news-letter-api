...
type Newsletter struct {
	...
	Subscribers []NewsletterSubscriber  `gorm:"foreignKey:NewsletterID;references:ID;constraint:OnDelete:CASCADE"`
	User        user_model.User         `gorm:"foreignKey:AdminID;references:ID;constraint:OnDelete:CASCADE"`
}
